...
df <- filter(df, CAS_No == "95-14-7")

# Cleaning data for feature table #   
df <- select(df, -SUBID:-Concentration, -kbiodeg:-ks,  -valid_measurement, -sub_groups, -censored, -reach_bin:-emission_soil)  # -subs_value, -censored
